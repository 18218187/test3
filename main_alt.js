$(function () {
  !(function (e, n, t) {
    ...
    function m(e, t, r, o) {
      ...
      if (parseInt(r, 10))
        for (; r--; )
          ((a = l("div")).id = o ? o[r] : u + (r + 1)), p.appendChild(a);
      return (
  ...
  var enableInlineVideo = (function () {
      ...
      function n(e, i, n, r) {
        function t(i) {
          Boolean(e[n]) === Boolean(r) && i.stopImmediatePropagation(),
            delete e[n];
        }
      ...
      function o(e, i, n) {
        (m || 0) + 200 < Date.now() && ((e[b] = !0), (m = Date.now())),
          n || (e.currentTime = i),
          (w[++T % 3] = (100 * i) | 0);
      }
      function u(e) {
      ...
      function s(e) {
        ...
        i.video.readyState >= i.video.HAVE_FUTURE_DATA
          ? (i.hasAudio ||
              ...
              i.video.loop && u(i) && (i.driver.currentTime = 0)),
            o(i.video, i.driver.currentTime))
          : i.video.networkState === i.video.NETWORK_IDLE &&
            0 === i.video.buffered.length &&
            i.video.load(),
          i.video.ended && (delete i.video[b], i.video.pause(!0));
      }
      function c() {
        var e = this,
          i = e[h];
      ...
      function v(e) {
        ...
        n.driver.pause(),
          n.updater.stop(),
          i.webkitDisplayingFullscreen && i[E](),
          (n.paused && !e) ||
            ((n.paused = !0),
            n.hasAudio || d(i, "pause"),
            i.ended && ((i[b] = !0), d(i, "ended")));
      }
      function p(e, n) {
        var r = (e[h] = {});
        (r.paused = !0),
          ...
          e.addEventListener(
            ...
            function () {
              ...
              r.driver.src &&
                ...
                (o(e, 0, !0),
                (r.driver.src = e.src),
                i ? r.driver.play() : r.updater.stop());
            },
            !1
          ),
          ...
          n &&
            ...
            e.addEventListener("seeking", function () {
              w.indexOf((100 * e.currentTime) | 0) < 0 &&
                (r.driver.currentTime = e.currentTime);
            }));
      }
      function l(e) {
      ...
      function f(e, i) {
        if ((void 0 === i && (i = {}), !e[h])) {
          ...
          !e.paused && e.webkitDisplayingFullscreen && e.pause(),
            p(e, !e.muted),
            l(e),
            e.classList.add("IIV"),
            e.muted && e.autoplay && e.play(),
    ...
    wrapVideo = document.querySelector(".video-wrap"),
    poster = $(".poster"),
  ...
  function videoLogic() {
    $("[data-play]").on("click", function () {
      ...
      setTimeout(function () {
        ...
        (video.currentTime = playTime), video.play();
        wrapVideo.classList.remove("is--blurry");
      ...
      video.addEventListener("timeupdate", function () {
        ...
        video.currentTime > 0.1 &&
          !poster.hasClass("is--hidden") &&
          (poster.addClass("is--hidden"),
          wrapVideo.classList.remove("is--blurry", "poster-active"),
          activeStep.removeClass("is--visible")),
          videoStopped != currentTime && (videoStopped = !1),
          videoStopped ||
            (currentTime ===
              parseInt(activeStep.find("[data-stop]").data("stop")) &&
              (video.pause(), (videoStopped = currentTime)));
      }),
      video.addEventListener("pause", function (old_step, new_step) {
        ...
        $new_step_int = $old_step + 1;

        if (did_show_results) {
          resetResults();
        }
        window.scrollTo(0, 0),
          old_step != new_step && old_step <= numSteps
            ? ($old_step.removeClass("is--active"),
              $old_step.find(".steps-wrap").height(0),
            ...
            : ((queryErrors = !0),
              ...
              (activeStep = $new_step),
              video.pause()),
          wrapVideo.classList.add("is--blurry");
        if ($new_step_int == 6 && !$("body").hasClass("style_alt2")) {
          // $new_step = $("[data-step=" + ($old_step + 1) + "]")
          // .hide()
          // .fadeIn(500);
          finalCarousel();
    ...
    $(".final-next").on("click", function () {
      $(this).parents(".step").hide().next().hide().fadeIn(500);
      finalCarousel();
    });
    function finalCarousel() {
      ...
      setTimeout(function () {
        mySwiper.slideToLoop(9, 1500, true);
      }, 400);
    }
  }
  ...
  function setVideoFallback() {
    if ((checkOrientation(isMobile), isMobile)) {
      ...
      !isiDevice || ($("html").addClass("is--ios"), enableInlineVideo(video)),
        isAndroid && $("html").addClass("is--android");
